...
#define FILENAME "/home/talegria/xboardoutput.txt"

void wrtBoardMsgu(char *str1){
...
StartChildProcess (char *cmdLine, char *dir, ProcRef *pr)
{
  ...
  wrtBoardMsgu("usystem.startchild process --->  ");
  wrtBoardMsgu(cmdLine);
  wrtBoardMsgu("\n");
    ...
    char tam1[512];
    wrtBoardMsgu("usystem.startchild toprog --->  ");
    sprintf(tam1," %i ",to_prog[0]);
    wrtBoardMsgu(tam1);
    wrtBoardMsgu(" -- ");
    sprintf(tam1," %i ",to_prog[1]);
    wrtBoardMsgu(tam1);
    wrtBoardMsgu("\n");

    wrtBoardMsgu("usystem.startchild toprog --->  ");
    sprintf(tam1," %i ",from_prog[0]);
    wrtBoardMsgu(tam1);
    wrtBoardMsgu(" -- ");
    sprintf(tam1," %i ",from_prog[1]);
    wrtBoardMsgu(tam1);
    wrtBoardMsgu("\n");
    ...
    if ((pid = fork()) == 0) {
        ...
        wrtBoardMsgu("usystem.startchild before exec --->  ");
        sprintf(tam1," %s ",argv[0]);
        wrtBoardMsgu(tam1);
        wrtBoardMsgu("\n");
        execvp(argv[0], argv);
